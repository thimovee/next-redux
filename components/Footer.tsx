                ...
                <footer className="z-50 bg-[#111111] w-full h-[350px] flex justify-between text-white">
                    <div className="my-auto ml-32">
                        <div className="flex flex-col">
                            ...
                            <div className="mt-6 mb-9 text-[#a1a1a1] hover:text-white">  ©Thimo</div>
                            <div><a href="https://dopegood.com/" className="text-[#a1a1a1] hover:text-purple-600 cursor-pointer">Design</a></div>
                        </div>
                    </div>
                    <div className="my-auto text-[#a1a1a1] text-lg">
                        <div className="flex flex-col">
                            <div className="hover:text-purple-600 cursor-pointer">thimo@gmail.com</div>
                            <div className="my-9 hover:text-purple-600 cursor-pointer">+31623456789</div>
                            <div className="hover:text-purple-600 cursor-pointer"> 2345 ER - Tiel </div>
                        </div>
                    </div>
                    <div className="my-auto text-[#a1a1a1] text-lg leading-6">
                        <div className="flex flex-col">
                            <div className="hover:text-purple-600 cursor-pointer">About Us</div>
                            <div className="my-9 hover:text-purple-600 cursor-pointer">Privacy Policy</div>
                            <div className="hover:text-purple-600 cursor-pointer" >Terms & Conditions </div>
                        </div>
                    </div>
                    <div className="my-auto mr-32">
                        <div className="flex flex-col">
                            ...
                            <div className="w-[400px] h-14">
                                <div className="bg-[#303233] px-9  h-[56px] mt-[20px] rounded-full"><input type="email" placeholder="Enter your mail" className="focus:outline-none w-[305px] h-[56px] bg-[#303233] text-[#A1A1A1]" /><button className="hover:scale-105 hover:bg-purple-600 transition duration-300 ease-in absolute translate-x-[10%] -translate-y-[0%] bg-[color:var(--accent-color)] w-14 h-14 rounded-full text-white"><svg className="h-6 w-6 mx-auto" stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg></button></div>
                            </div>
                        </div>
                    </div>
                </footer>
